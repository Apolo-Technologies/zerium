...
type Engine interface {
	...
	// VerifyHeader checks whzerium a header conforms to the consensus rules of a
	...
	// VerifySeal checks whzerium the crypto seal on a header is valid according to
