...
// Package consensus implements different Zerium consensus engines.
package consensus
...
type Engine interface {
	// Author retrieves the Zerium address of the account that minted the given
	// block, which may be different from the header's coinbase if a consensus
	// engine is based on signatures.
	Author(header *types.Header) (zrmcom.Address, error)
