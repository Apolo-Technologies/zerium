...
func (ethash *Ethash) Author(header *types.Header) (zrmcom.Address, error) {
	return header.Coinbase, nil
}

// VerifyHeader checks whether a header conforms to the consensus rules of the
// stock Zerium ethash engine.
...
// rules of the stock Zerium ethash engine.
func (ethash *Ethash) VerifyUncles(chain consensus.ChainReader, block *types.Block) error {
	...
	uncles, ancestors := set.New(), make(map[zrmcom.Hash]*types.Header)
...
func calcDifficultyByzantium(time uint64, parent *types.Header) *big.Int {
	...
	// the exponential factor, zrmcomly referred to as "the bomb"
