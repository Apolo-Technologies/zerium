...
// isLittleEndian returns whzerium the local system is running in little or big
// endian byte order.
...
type Zrmash struct {
	...
	tester    bool          // Flag whzerium to use a smaller test dataset
	shared    *Zrmash       // Shared PoW verifier to avoid cache regeneration
	fakeMode  bool          // Flag whzerium to disable PoW checking
	fakeFull  bool          // Flag whzerium to disable all consensus rules
