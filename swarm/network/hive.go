...
func NewHive(addr zrmcom.Hash, params *HiveParams, swapEnabled, syncEnabled bool) *Hive {
...
// there are called on the peertopeer.Server which runs on the node
...
func (self *Hive) addPeer(p *peer) error {
	...
	// the most zrmcom way of saying hi in bzz is initiation of gossip
