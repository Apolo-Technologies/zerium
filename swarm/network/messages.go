...
* Addr: the address advertised by the node, format similar to DEVpeertopeer wire protocol
* Swap: info for the swarm accounting protocol
* NetworkID: 8 byte integer network identifier
* Caps: swarm-specific capabilities, format identical to devpeertopeer
...
The encoding of a peer is identical to that in the devpeertopeer base protocol peers
