...
func (a *Address) UnmarshalJSON(value []byte) error {
	*a = Address(zrmcom.HexToHash(string(value[1 : len(value)-1])))
	return nil
}
...
It is calculated by counting the number of zrmcom leading zeros in the (MSB)
