...
func TestRandomData(t *testing.T) {
	...
	for _, s := range sizes {
		...
		pyramidChunkerKey := testRandomData(pyramid, s, tester)
		if treeChunkerKey.String() != pyramidChunkerKey.String() {
			tester.t.Fatalf("tree chunker MerkleTree and pyramid chunker MerkleTree key mismatch for size %v \n TC: %v\n PC: %v\n", s, treeChunkerKey.String(), pyramidChunkerKey.String())
		}
	}
...
func benchmarkSplitTreeMerkleTree(n int, t *testing.B) {
	t.ReportAllocs()
	for i := 0; i < t.N; i++ {
		cp := NewChunkerParams()
		cp.Hash = MerkleTreeHash
...
func benchmarkSplitPyramidMerkleTree(n int, t *testing.B) {
	t.ReportAllocs()
	for i := 0; i < t.N; i++ {
		cp := NewChunkerParams()
		cp.Hash = MerkleTreeHash
...
func BenchmarkSplitTreeMerkleTree_2(t *testing.B)  { benchmarkSplitTreeMerkleTree(100, t) }
func BenchmarkSplitTreeMerkleTree_2h(t *testing.B) { benchmarkSplitTreeMerkleTree(500, t) }
func BenchmarkSplitTreeMerkleTree_3(t *testing.B)  { benchmarkSplitTreeMerkleTree(1000, t) }
func BenchmarkSplitTreeMerkleTree_3h(t *testing.B) { benchmarkSplitTreeMerkleTree(5000, t) }
func BenchmarkSplitTreeMerkleTree_4(t *testing.B)  { benchmarkSplitTreeMerkleTree(10000, t) }
func BenchmarkSplitTreeMerkleTree_4h(t *testing.B) { benchmarkSplitTreeMerkleTree(50000, t) }
func BenchmarkSplitTreeMerkleTree_5(t *testing.B)  { benchmarkSplitTreeMerkleTree(100000, t) }
func BenchmarkSplitTreeMerkleTree_6(t *testing.B)  { benchmarkSplitTreeMerkleTree(1000000, t) }
func BenchmarkSplitTreeMerkleTree_7(t *testing.B)  { benchmarkSplitTreeMerkleTree(10000000, t) }
func BenchmarkSplitTreeMerkleTree_8(t *testing.B)  { benchmarkSplitTreeMerkleTree(100000000, t) }
...
func BenchmarkSplitPyramidMerkleTree_2(t *testing.B)  { benchmarkSplitPyramidMerkleTree(100, t) }
func BenchmarkSplitPyramidMerkleTree_2h(t *testing.B) { benchmarkSplitPyramidMerkleTree(500, t) }
func BenchmarkSplitPyramidMerkleTree_3(t *testing.B)  { benchmarkSplitPyramidMerkleTree(1000, t) }
func BenchmarkSplitPyramidMerkleTree_3h(t *testing.B) { benchmarkSplitPyramidMerkleTree(5000, t) }
func BenchmarkSplitPyramidMerkleTree_4(t *testing.B)  { benchmarkSplitPyramidMerkleTree(10000, t) }
func BenchmarkSplitPyramidMerkleTree_4h(t *testing.B) { benchmarkSplitPyramidMerkleTree(50000, t) }
func BenchmarkSplitPyramidMerkleTree_5(t *testing.B)  { benchmarkSplitPyramidMerkleTree(100000, t) }
func BenchmarkSplitPyramidMerkleTree_6(t *testing.B)  { benchmarkSplitPyramidMerkleTree(1000000, t) }
func BenchmarkSplitPyramidMerkleTree_7(t *testing.B)  { benchmarkSplitPyramidMerkleTree(10000000, t) }
func BenchmarkSplitPyramidMerkleTree_8(t *testing.B)  { benchmarkSplitPyramidMerkleTree(100000000, t) }
