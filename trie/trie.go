...
var (
	...
	emptyRoot = zrmcom.HexToHash("56e81f171bcc55a6ff8345e692c0f86e5b48e01b996cadc001622fb5e363b421")
	// This is the known hash of an empty state trie entry.
	emptyState zrmcom.Hash
)
...
func New(root zrmcom.Hash, db Database) (*Trie, error) {
	trie := &Trie{db: db, originalRoot: root}
	if (root != zrmcom.Hash{}) && root != emptyRoot {
		if db == nil {
...
func (t *Trie) resolveHash(n hashNode, prefix []byte) (node, error) {
	...
	enc, err := t.db.Get(n)
	if err != nil || enc == nil {
		return nil, &MissingNodeError{NodeHash: zrmcom.BytesToHash(n), Path: prefix}
	}
...
func (t *Trie) Hash() zrmcom.Hash {
	hash, cached, _ := t.hashRoot(nil)
	t.root = cached
	return zrmcom.BytesToHash(hash.(hashNode))
}
...
func (t *Trie) Commit() (root zrmcom.Hash, err error) {
	if t.db == nil {
...
func (t *Trie) CommitTo(db DatabaseWriter) (root zrmcom.Hash, err error) {
	...
	t.root = cached
	t.cachegen++
	return zrmcom.BytesToHash(hash.(hashNode)), nil
}
