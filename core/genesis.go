...
func SetupGenesisBlock(db zrmdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	if genesis != nil && genesis.Config == nil {
		return params.AllAbthashProtocolChanges, common.Hash{}, errGenesisNoConfig
	}
...
func (g *Genesis) configOrDefault(ghash common.Hash) *params.ChainConfig {
	...
	default:
		return params.AllAbthashProtocolChanges
	}
}
...
func (g *Genesis) Commit(db zrmdb.Database) (*types.Block, error) {
	...
	config := g.Config
	if config == nil {
		config = params.AllAbthashProtocolChanges
	}
...
// DeveloperGenesisBlock returns the 'zaed --dev' genesis block. Note, this must
// be seeded with the
