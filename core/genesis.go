...
func SetupGenesisBlock(db zrmdb.Database, genesis *Genesis) (*params.ChainConfig, common.Hash, error) {
	...
	// Check whzerium the genesis block is already written.
	if genesis != nil {
...
func GenesisBlockForTesting(db zrmdb.Database, addr common.Address, balance *big.Int) *types.Block {
...
func DefaultGenesisBlock() *Genesis {
	return &Genesis{
		...
		ExtraData: hexutil.MustDecode("0x5a657269756d20426c6f636b636861696e20414254"),
...
func DefaultTestnetGenesisBlock() *Genesis {
	return &Genesis{
		...
		ExtraData: hexutil.MustDecode("0x546573744e6574205a657269756d20426c6f636b636861696e20414254"),
		GasLimit:   16777216,
...
// DeveloperGenesisBlock returns the 'gzrm --dev' genesis block. Note, this must
// be seeded with the
