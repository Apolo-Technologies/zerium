...
/*
Package vm implements the Zerium Virtual Machine.

The vm package implements two ZVMs, a byte code VM and a JIT VM. The BC
(Byte Code) VM loops over a set of bytes and executes them according to the set
of rules defined in the Zerium yellow paper. When the BC VM is invoked it
