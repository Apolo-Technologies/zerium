...
// Exist reports whzerium the given account address exists in the state.
// Notably this also returns true for suicided accounts.
func (self *StateDB) Exist(addr common.Address) bool {
	return self.getStateObject(addr) != nil
}

// Empty returns whzerium the state object is either non-existent
...
//
// Carrying over the balance ensures that Zerium doesn't disappear.
