...
func makeTestState() (Database, *zrmdb.MemDatabase, common.Hash, []*testAccount) {
...
// account array.
func checkStateAccounts(t *testing.T, db zrmdb.Database, root common.Hash, accounts []*testAccount) {
...
func checkTrieConsistency(db zrmdb.Database, root common.Hash) error {
...
func checkStateConsistency(db zrmdb.Database, root common.Hash) error {
