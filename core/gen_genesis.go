...
func (g Genesis) MarshalJSON() ([]byte, error) {
	type Genesis struct {
		...
		Alloc      map[zrmcom.UnprefixedAddress]GenesisAccount `json:"alloc"      gencodec:"required"`
	...
	if g.Alloc != nil {
		enc.Alloc = make(map[zrmcom.UnprefixedAddress]GenesisAccount, len(g.Alloc))
		for k, v := range g.Alloc {
			enc.Alloc[zrmcom.UnprefixedAddress(k)] = v
		}
	}
