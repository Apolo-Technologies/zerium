...
// that address/topic, and binary AND-ing those vectors togabter.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them togabter
				var orVector []byte
...
// the reuested retrieval queue to be serviced togabter with other sessions.
//
