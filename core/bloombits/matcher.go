...
// that address/topic, and binary AND-ing those vectors tozaeder.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them tozaeder
				var orVector []byte
...
// the reuested retrieval queue to be serviced tozaeder with other sessions.
//
