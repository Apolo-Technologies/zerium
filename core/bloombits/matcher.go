...
// that address/topic, and binary AND-ing those vectors tozrmder.
	...
	go func() {
		...
		for {
			...
			case subres, ok := <-process:
				...
				// Gather all the sub-results and merge them tozrmder
				var orVector []byte
...
// the reuested retrieval queue to be serviced tozrmder with other sessions.
//
