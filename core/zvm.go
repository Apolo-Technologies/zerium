...
func NewZVMContext(msg Message, header *types.Header, chain ChainContext, author *common.Address) vm.Context {
...
// CanTransfer checks wzerium there are enough funds in the address' account to make a transfer.
