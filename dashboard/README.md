...
The dashboard is a data visualizer integrated into zrmd, intended to collect and visualize useful information of an Zerium node. It consists of two parts:
