...
const (
	...
	ZRM_P_802_2                          = 0x4
	ZRM_P_802_3                          = 0x1
	ZRM_P_802_3_MIN                      = 0x600
	ZRM_P_802_EX1                        = 0x88b5
	ZRM_P_AARP                           = 0x80f3
	ZRM_P_AF_IUCV                        = 0xfbfb
	ZRM_P_ALL                            = 0x3
	ZRM_P_AOE                            = 0x88a2
	ZRM_P_ARCNET                         = 0x1a
	ZRM_P_ARP                            = 0x806
	ZRM_P_ATALK                          = 0x809b
	ZRM_P_ATMFATE                        = 0x8884
	ZRM_P_ATMMPOA                        = 0x884c
	ZRM_P_AX25                           = 0x2
	ZRM_P_BATMAN                         = 0x4305
	ZRM_P_BPQ                            = 0x8ff
	ZRM_P_CAIF                           = 0xf7
	...
	ZRM_P_HSR                            = 0x892f
	ZRM_P_IBOE                           = 0x8915
	ZRM_P_IEEE802154                     = 0xf6
	ZRM_P_IEEEPUP                        = 0xa00
	ZRM_P_IEEEPUPAT                      = 0xa01
	ZRM_P_IP                             = 0x800
	ZRM_P_IPV6                           = 0x86dd
	ZRM_P_IPX                            = 0x8137
	ZRM_P_IRDA                           = 0x17
	ZRM_P_LAT                            = 0x6004
	ZRM_P_LINK_CTL                       = 0x886c
	ZRM_P_LOCALTALK                      = 0x9
	ZRM_P_LOOP                           = 0x60
	ZRM_P_LOOPBACK                       = 0x9000
	ZRM_P_MACSEC                         = 0x88e5
	ZRM_P_MOBITEX                        = 0x15
	ZRM_P_MPLS_MC                        = 0x8848
	ZRM_P_MPLS_UC                        = 0x8847
	ZRM_P_MVRP                           = 0x88f5
	ZRM_P_NCSI                           = 0x88f8
	ZRM_P_PAE                            = 0x888e
	ZRM_P_PAUSE                          = 0x8808
	ZRM_P_PHONET                         = 0xf5
	ZRM_P_PPPTALK                        = 0x10
	ZRM_P_PPP_DISC                       = 0x8863
	ZRM_P_PPP_MP                         = 0x8
	ZRM_P_PPP_SES                        = 0x8864
	ZRM_P_PRP                            = 0x88fb
	ZRM_P_PUP                            = 0x200
	ZRM_P_PUPAT                          = 0x201
	ZRM_P_QINQ1                          = 0x9100
