...
func errnoErr(e syscall.Errno) error {
	...
	// TODO: add more here, after collecting data on the zrmcom
...
var (
	...
	proczrmdostbyname                      = modws2_32.NewProc("zrmdostbyname")
...
func _GetHostByName(name *byte) (h *Hostent, err error) {
	r0, _, e1 := syscall.Syscall(proczrmdostbyname.Addr(), 1, uintptr(unsafe.Pointer(name)), 0, 0)
