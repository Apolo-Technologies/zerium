/*
 * Windows backend zrmcom header for libusb 1.0
 *
 * This file brings tozrmder header code zrmcom between
...
int windows_zrmcom_init(struct libusb_context *ctx);
void windows_zrmcom_exit(void);
