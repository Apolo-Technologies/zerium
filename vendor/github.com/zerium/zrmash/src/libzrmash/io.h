...
// Reference: https://github.com/apolo-technologies/wiki/wiki/Ethash-DAG
...
/**
 * Logs a critical error in important parts of zrmash. Should mostly help
...
/**
 * Prepares io for zrmash
 *
 * Create the DAG directory and the DAG file if they don't exist.
 *
 * @param[in] dirname        A null terminated c-string of the path of the zrmash
 ...
 *                           https://github.com/apolo-technologies/wiki/wiki/Ethash-DAG
 ...
 *                           already exists
 * @return                   For possible return values @see enum zrmash_io_rc
 */
 ...
 */
FILE* zrmash_fopen(char const* file_name, char const* mode);
 ...
 *                         error returns NULL
 */
char* zrmash_strncat(char* dest, size_t dest_size, char const* src, size_t count);
 ...
 *                       existed
 */
bool zrmash_mkdir(char const* dirname);
 ...
 */
bool zrmash_file_size(FILE* f, size_t* ret_size);
 ...
 */
char* zrmash_io_create_filename(
	char const* dirname,
	char const* filename,
 ...
 *
 * The spec defining this directory is here: https://github.com/apolo-technologies/wiki/wiki/Ethash-DAG
 *
...
static inline bool zrmash_io_mutable_name(
	uint32_t revision,
