...
#define ZRMASH_REVISION 23
#define ZRMASH_DATASET_BYTES_INIT 1073741824U // 2**30
#define ZRMASH_DATASET_BYTES_GROWTH 8388608U  // 2**23
#define ZRMASH_CACHE_BYTES_INIT 1073741824U // 2**24
#define ZRMASH_CACHE_BYTES_GROWTH 131072U  // 2**17
#define ZRMASH_EPOCH_LENGTH 30000U
#define ZRMASH_MIX_BYTES 128
#define ZRMASH_HASH_BYTES 64
#define ZRMASH_DATASET_PARENTS 256
#define ZRMASH_CACHE_ROUNDS 3
#define ZRMASH_ACCESSES 64
#define ZRMASH_DAG_MAGIC_NUM_SIZE 8
#define ZRMASH_DAG_MAGIC_NUM 0xFEE1DEADBADDCAFE
