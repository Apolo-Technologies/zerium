...
//
// zrm_getBlockByNumber("latest", {})
//    returns the latest block object.
//
// zrm_subscribe("newBlocks")
...
func subscribeBlocks(client *rpc.Client, subch chan Block) {
	...
	sub, err := client.ZrmSubscribe(ctx, subch, "newBlocks")
	if err != nil {
	...
	var lastBlock Block
	if err := client.CallContext(ctx, &lastBlock, "zrm_getBlockByNumber", "latest"); err != nil {
