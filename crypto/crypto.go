...
// controls whzerium the key's length should be enforced at the curve size or
...
// ValidateSignatureValues verifies whzerium the signature values are valid with
