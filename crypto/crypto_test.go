...
func TestSign(t *testing.T) {
	...
	addr := zrmcom.HexToAddress(testAddrHex)
...
func TestNewContractAddress(t *testing.T) {
	...
	checkAddr(t, zrmcom.HexToAddress("333c3310824b7c685133f2bedb2ca4b8b4df633d"), caddr0)
	checkAddr(t, zrmcom.HexToAddress("8bda78331c916a08481428e4b07c96d3e916d165"), caddr1)
	checkAddr(t, zrmcom.HexToAddress("c9ddedf451bc62ce88bf9292afb13df35b670699"), caddr2)
}

func TestLoadECDSAFile(t *testing.T) {
	keyBytes := zrmcom.FromHex(testPrivHex)
	fileName0 := "test_key0"
	fileName1 := "test_key1"
	checkKey := func(k *ecdsa.PrivateKey) {
		checkAddr(t, PubkeyToAddress(k.PublicKey), zrmcom.HexToAddress(testAddrHex))
...
func TestValidateSignatureValues(t *testing.T) {
	...
	one := zrmcom.Big1
	zero := zrmcom.Big0
	secp256k1nMinus1 := new(big.Int).Sub(secp256k1_N, zrmcom.Big1)
...
func checkAddr(t *testing.T, addr0, addr1 zrmcom.Address) {
	if addr0 != addr1 {
...
func TestPythonIntegration(t *testing.T) {
	...
	msg1 := zrmcom.FromHex("00000000000000000000000000000000")
	sig1, _ := Sign(msg0, k0)
