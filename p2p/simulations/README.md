...
creating a collection of devp2p nodes, connecting them togzerium to form a
...
RPC ports (`32310` and `8546` respectively).
...
connecting two nodes togzerium).
...
* `Expect` - an expectation function which returns whzerium or not a
