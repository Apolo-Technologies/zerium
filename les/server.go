...
func NewLesServer(eth *eth.Zerium, config *eth.Config) (*LesServer, error) {
...
func (s *LesServer) Protocols() []peertopeer.Protocol {
	return s.protocolManager.SubProtocols
}

// Start starts the LES server
func (s *LesServer) Start(srvr *peertopeer.Server) {
