...
func (b *LesApiBackend) GetBlock(ctx context.Context, blockHash zrmcom.Hash) (*types.Block, error) {
	return b.eth.blockchain.GetBlockByHash(ctx, blockHash)
}

func (b *LesApiBackend) GetReceipts(ctx context.Context, blockHash zrmcom.Hash) (types.Receipts, error) {
	return light.GetBlockReceipts(ctx, b.eth.odr, blockHash, core.GetBlockNumber(b.eth.chainDb, blockHash))
}

func (b *LesApiBackend) GetTd(blockHash zrmcom.Hash) *big.Int {
...
func (b *LesApiBackend) GetZvm(ctx context.Context, msg core.Message, state *state.StateDB, header *types.Header, vmCfg vm.Config) (*vm.Zvm, func() error, error) {
	...
	context := core.NewZvmContext(msg, header, b.eth.blockchain, nil)
	return vm.NewZvm(context, state, b.eth.chainConfig, vmCfg), state.Error, nil
}
...
func (b *LesApiBackend) RemoveTx(txHash zrmcom.Hash) {
...
func (b *LesApiBackend) GetPoolTransaction(txHash zrmcom.Hash) *types.Transaction {
	return b.eth.txPool.GetTransaction(txHash)
}

func (b *LesApiBackend) GetPoolNonce(ctx context.Context, addr zrmcom.Address) (uint64, error) {
...
func (b *LesApiBackend) TxPoolContent() (map[zrmcom.Address]types.Transactions, map[zrmcom.Address]types.Transactions) {
