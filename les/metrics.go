...
var (
	/*	propTxnInPacketsMeter     = metrics.NewMeter("zrm/prop/txns/in/packets")
		...
		reqHashInPacketsMeter     = metrics.NewMeter("zrm/req/hashes/in/packets")
		reqHashInTrafficMeter     = metrics.NewMeter("zrm/req/hashes/in/traffic")
		reqHashOutPacketsMeter    = metrics.NewMeter("zrm/req/hashes/out/packets")
		reqHashOutTrafficMeter    = metrics.NewMeter("zrm/req/hashes/out/traffic")
		reqBlockInPacketsMeter    = metrics.NewMeter("zrm/req/blocks/in/packets")
		reqBlockInTrafficMeter    = metrics.NewMeter("zrm/req/blocks/in/traffic")
		reqBlockOutPacketsMeter   = metrics.NewMeter("zrm/req/blocks/out/packets")
		reqBlockOutTrafficMeter   = metrics.NewMeter("zrm/req/blocks/out/traffic")
