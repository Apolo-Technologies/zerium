...
type ChainReader interface {
	BlockByHash(ctx context.Context, hash zrmcom.Hash) (*types.Block, error)
	BlockByNumber(ctx context.Context, number *big.Int) (*types.Block, error)
	HeaderByHash(ctx context.Context, hash zrmcom.Hash) (*types.Header, error)
	HeaderByNumber(ctx context.Context, number *big.Int) (*types.Header, error)
	TransactionCount(ctx context.Context, blockHash zrmcom.Hash) (uint, error)
	TransactionInBlock(ctx context.Context, blockHash zrmcom.Hash, index uint) (*types.Transaction, error)
...
type TransactionReader interface {
	...
	// it's not pending.
	TransactionByHash(ctx context.Context, txHash zrmcom.Hash) (tx *types.Transaction, isPending bool, err error)
...
type ChainStateReader interface {
	BalanceAt(ctx context.Context, account zrmcom.Address, blockNumber *big.Int) (*big.Int, error)
	StorageAt(ctx context.Context, account zrmcom.Address, key zrmcom.Hash, blockNumber *big.Int) ([]byte, error)
	CodeAt(ctx context.Context, account zrmcom.Address, blockNumber *big.Int) ([]byte, error)
	NonceAt(ctx context.Context, account zrmcom.Address, blockNumber *big.Int) (uint64, error)
}
...
type CallMsg struct {
	From     zrmcom.Address  // the sender of the 'transaction'
	To       *zrmcom.Address // the destination contract (nil for contract creation)
...
type FilterQuery struct {
	...
	Addresses []zrmcom.Address // restricts matches to events created by specific contracts
...
// zrmcomly used to display the result of ’unconfirmed’ actions (e.g. wallet value
...
type PendingStateReader interface {
	PendingBalanceAt(ctx context.Context, account zrmcom.Address) (*big.Int, error)
	PendingStorageAt(ctx context.Context, account zrmcom.Address, key zrmcom.Hash) ([]byte, error)
	PendingCodeAt(ctx context.Context, account zrmcom.Address) ([]byte, error)
	PendingNonceAt(ctx context.Context, account zrmcom.Address) (uint64, error)
