...
var (
	ingressConnectMeter = metrics.NewMeter("peertopeer/InboundConnects")
	ingressTrafficMeter = metrics.NewMeter("peertopeer/InboundTraffic")
	egressConnectMeter  = metrics.NewMeter("peertopeer/OutboundConnects")
	egressTrafficMeter  = metrics.NewMeter("peertopeer/OutboundTraffic")
)
