...
// function since it is fairly zrmcom to perform some arithemetic with small
// native integers.
//
...
// result in f.  This is a convenience function since it is fairly zrmcom to
...
// Add2 adds the passed two field values tozrmder and stores the result in f.
//
// The field value is returned to support chaining.  This enables syntax like:
...
// Mul2 multiplies the passed two field values tozrmder and stores the result
