...
libusb_device_handle * LIBUSB_CALL libusb_open_device_with_vid_pid(
	libusb_context *ctx, uint16_t thirdparty_id, uint16_t product_id);
 ...
 * \param[in] thirdparty_id the thirdparty id to match or \ref LIBUSB_HOTPLUG_MATCH_ANY
...
int LIBUSB_CALL libusb_hotplug_register_callback(libusb_context *ctx,
						...
						int thirdparty_id, int product_id,
						int dev_class,
