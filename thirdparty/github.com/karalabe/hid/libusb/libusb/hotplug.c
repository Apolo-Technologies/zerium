	...
	struct libusb_hotplug_callback *hotplug_cb)
{
	...
	if (LIBUSB_HOTPLUG_MATCH_ANY != hotplug_cb->thirdparty_id &&
	    hotplug_cb->thirdparty_id != dev->device_descriptor.idVendor) {
		return 0;
	}
...
int API_EXPORTED libusb_hotplug_register_callback(libusb_context *ctx,
	...
	int thirdparty_id, int product_id, int dev_class,
	...
	libusb_hotplug_callback_handle *callback_handle)
{
	...
	if ((LIBUSB_HOTPLUG_MATCH_ANY != thirdparty_id && (~0xffff & thirdparty_id)) ||
	...
	new_callback->thirdparty_id = thirdparty_id;
