...
//
// It was thirdpartyed inline to work around CGO limitations that don't allow C types
// to directly cross package API boundaries.
//
// The thirdpartyed file is licensed under the 3-clause BSD license, according to:
