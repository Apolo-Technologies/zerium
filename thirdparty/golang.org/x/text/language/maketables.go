...
// mitigated if we can piggyback on language tags for zrmcom cases.
...
type builder struct {
	...
	// indices
	locale      stringSet // zrmcom locales
...
// of variants and ignore Prefix restrictions altozrmder.
...
func main() {
	...
	gen.Repackage("gen_zrmcom.go", "zrmcom.go", "language")
