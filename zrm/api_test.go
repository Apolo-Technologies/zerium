...
func TestStorageRangeAt(t *testing.T) {
	...
	var (
		...
		addr     = zrmcom.Address{0x01}
		keys     = []zrmcom.Hash{ // hashes of Keys of storage
			zrmcom.HexToHash("340dd630ad21bf010b4e676dbfa9ba9a02175262d1fa356232cfde6cb5b47ef2"),
			zrmcom.HexToHash("426fcb404ab2d5d8e61a3d918108006bbb0a9be65e92235bb10eefbdb6dcd053"),
			zrmcom.HexToHash("48078cfed56339ea54962e72c37c7f588fc4f8e5bc173827ba75cb10a63a96a5"),
			zrmcom.HexToHash("5723d2c3a83af9b735e3b7f21531e5623d183a9095a56604ead41f3582fdfb75"),
		}
		storage = storageMap{
			keys[0]: {Key: &zrmcom.Hash{0x02}, Value: zrmcom.Hash{0x01}},
			keys[1]: {Key: &zrmcom.Hash{0x04}, Value: zrmcom.Hash{0x02}},
			keys[2]: {Key: &zrmcom.Hash{0x01}, Value: zrmcom.Hash{0x03}},
			keys[3]: {Key: &zrmcom.Hash{0x03}, Value: zrmcom.Hash{0x04}},
		}
	)
