...
// Syncing provides information when this nodes starts synchronising with the Zerium network and when it's finished.
...
type SyncingResult struct {
	...
	Status  zerium.SyncProgress `json:"status"`
}
