...
func (eth *Zerium) startBloomHandlers() {
...
// for the Zerium header bloom filters, permitting blazing fast filtering.
type BloomIndexer struct {
	...
	head    zrmcom.Hash // Head is the hash of the last header processed
}
...
// section.
func (b *BloomIndexer) Reset(section uint64, lastSectionHead zrmcom.Hash) error {
	gen, err := bloombits.NewGenerator(uint(b.size))
	b.gen, b.section, b.head = gen, section, zrmcom.Hash{}
	return err
}
