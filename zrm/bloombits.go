			...
			for {
				...
				case request := <-zrm.bloomRequests:
					...
					for i, section := range task.Sections {
						head := core.GetCanonicalHash(zrm.chainDb, (section+1)*params.BloomBitsBlocks-1)
						if compVector, err := core.GetBloomBits(zrm.chainDb, task.Bit, section, head); err == nil {
