...
// ApiBackend implements zrmapi.Backend for full nodes
...
func (b *ApiBackend) GetBlock(ctx context.Context, blockHash zrmcom.Hash) (*types.Block, error) {
	return b.zrm.blockchain.GetBlockByHash(blockHash), nil
}

func (b *ApiBackend) GetReceipts(ctx context.Context, blockHash zrmcom.Hash) (types.Receipts, error) {
	return core.GetBlockReceipts(b.zrm.chainDb, blockHash, core.GetBlockNumber(b.zrm.chainDb, blockHash)), nil
}

func (b *ApiBackend) GetTd(blockHash zrmcom.Hash) *big.Int {
	return b.zrm.blockchain.GetTdByHash(blockHash)
}

func (b *ApiBackend) GetZvm(ctx context.Context, msg core.Message, state *state.StateDB, header *types.Header, vmCfg vm.Config) (*vm.Zvm, func() error, error) {
...
func (b *ApiBackend) GetPoolTransaction(hash zrmcom.Hash) *types.Transaction {
	return b.zrm.txPool.Get(hash)
}

func (b *ApiBackend) GetPoolNonce(ctx context.Context, addr zrmcom.Address) (uint64, error) {
...
func (b *ApiBackend) TxPoolContent() (map[zrmcom.Address]types.Transactions, map[zrmcom.Address]types.Transactions) {
	return b.zrm.TxPool().Content()
}

func (b *ApiBackend) SubscribeTxPreEvent(ch chan<- core.TxPreEvent) event.Subscription {
...
func (b *ApiBackend) ChainDb() zrmdb.Database {
