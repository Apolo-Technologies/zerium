...
func TestFastSyncDisabling(t *testing.T) {
	...
	io1, io2 := peertopeer.MsgPipe()

	go pmFull.handle(pmFull.newPeer(63, peertopeer.NewPeer(discover.NodeID{}, "empty", nil), io2))
	go pmEmpty.handle(pmEmpty.newPeer(63, peertopeer.NewPeer(discover.NodeID{}, "full", nil), io1))
