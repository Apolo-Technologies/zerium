...
func GetHeaderByNumber(ctx context.Context, odr OdrBackend, number uint64) (*types.Header, error) {
	...
	if odr.ChtIndexer() != nil {
		...
		for chtCount > 0 && canonicalHash != sectionHead && canonicalHash != (zrmcom.Hash{}) {
			chtCount--
			if chtCount > 0 {
...
func GetCanonicalHash(ctx context.Context, odr OdrBackend, number uint64) (zrmcom.Hash, error) {
...
func GetBodyRLP(ctx context.Context, odr OdrBackend, hash zrmcom.Hash, number uint64) (rlp.RawValue, error) {
...
// hash.
func GetBody(ctx context.Context, odr OdrBackend, hash zrmcom.Hash, number uint64) (*types.Body, error) {
...
func GetBlock(ctx context.Context, odr OdrBackend, hash zrmcom.Hash, number uint64) (*types.Block, error) {
...
func GetBlockReceipts(ctx context.Context, odr OdrBackend, hash zrmcom.Hash, number uint64) (types.Receipts, error) {
...
func GetBloomBits(ctx context.Context, odr OdrBackend, bitIdx uint, sectionIdxList []uint64) ([][]byte, error) {
	...
	if odr.BloomTrieIndexer() != nil {
		...
		for bloomTrieCount > 0 && canonicalHash != sectionHead && canonicalHash != (zrmcom.Hash{}) {
			bloomTrieCount--
			if bloomTrieCount > 0 {
