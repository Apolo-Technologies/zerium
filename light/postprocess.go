...
import (
	...
	"github.com/apolo-technologies/zerium/zrmcom/bitutil"
...
type trustedCheckpoint struct {
	name                                string
	sectionIdx                          uint64
	sectionHead, chtRoot, bloomTrieRoot zrmcom.Hash
}
...
var (
	mainnetCheckpoint = trustedCheckpoint{
		name:          "ETH mainnet",
		sectionIdx:    129,
		sectionHead:   zrmcom.HexToHash("64100587c8ec9a76870056d07cb0f58622552d16de6253a59cac4b580c899501"),
		chtRoot:       zrmcom.HexToHash("bb4fb4076cbe6923c8a8ce8f158452bbe19564959313466989fda095a60884ca"),
		bloomTrieRoot: zrmcom.HexToHash("0db524b2c4a2a9520a42fd842b02d2e8fb58ff37c75cf57bd0eb82daeace6716"),
	}

	ropstenCheckpoint = trustedCheckpoint{
		name:          "Ropsten testnet",
		sectionIdx:    50,
		sectionHead:   zrmcom.HexToHash("00bd65923a1aa67f85e6b4ae67835784dd54be165c37f056691723c55bf016bd"),
		chtRoot:       zrmcom.HexToHash("6f56dc61936752cc1f8c84b4addabdbe6a1c19693de3f21cb818362df2117f03"),
		bloomTrieRoot: zrmcom.HexToHash("aca7d7c504d22737242effc3fdc604a762a0af9ced898036b5986c3a15220208"),
	}
)

// trustedCheckpoints associates each known checkpoint with the genesis hash of the chain it belongs to
var trustedCheckpoints = map[zrmcom.Hash]trustedCheckpoint{
...
func GetChtRoot(db zrmdb.Database, sectionIdx uint64, sectionHead zrmcom.Hash) zrmcom.Hash {
...
func GetChtV2Root(db zrmdb.Database, sectionIdx uint64, sectionHead zrmcom.Hash) zrmcom.Hash {
	return GetChtRoot(db, (sectionIdx+1)*(ChtFrequency/ChtV1Frequency)-1, sectionHead)
}

// StoreChtRoot writes the CHT root assoctiated to the given section into the database
// Note that sectionIdx is specified according to LES/1 CHT section size
func StoreChtRoot(db zrmdb.Database, sectionIdx uint64, sectionHead, root zrmcom.Hash) {
	var encNumber [8]byte
	binary.BigEndian.PutUint64(encNumber[:], sectionIdx)
...
type ChtIndexerBackend struct {
	...
	lastHash             zrmcom.Hash
	trie                 *trie.Trie
}

// NewBloomTrieIndexer creates a BloomTrie chain indexer
func NewChtIndexer(db zrmdb.Database, clientMode bool) *core.ChainIndexer {
	cdb := zrmdb.NewTable(db, ChtTablePrefix)
	idb := zrmdb.NewTable(db, "chtIndex-")
...
func (c *ChtIndexerBackend) Reset(section uint64, lastSectionHead zrmcom.Hash) error {
	var root zrmcom.Hash
	if section > 0 {
...
func GetBloomTrieRoot(db zrmdb.Database, sectionIdx uint64, sectionHead zrmcom.Hash) zrmcom.Hash {
	var encNumber [8]byte
	binary.BigEndian.PutUint64(encNumber[:], sectionIdx)
...
func StoreBloomTrieRoot(db zrmdb.Database, sectionIdx uint64, sectionHead, root zrmcom.Hash) {
	var encNumber [8]byte
	binary.BigEndian.PutUint64(encNumber[:], sectionIdx)
...
type BloomTrieIndexerBackend struct {
	...
	trie                                       *trie.Trie
	sectionHeads                               []zrmcom.Hash
}

// NewBloomTrieIndexer creates a BloomTrie chain indexer
func NewBloomTrieIndexer(db zrmdb.Database, clientMode bool) *core.ChainIndexer {
	cdb := zrmdb.NewTable(db, BloomTrieTablePrefix)
	idb := zrmdb.NewTable(db, "bltIndex-")
	...
	backend.sectionHeads = make([]zrmcom.Hash, backend.bloomTrieRatio)
...
// Reset implements core.ChainIndexerBackend
func (b *BloomTrieIndexerBackend) Reset(section uint64, lastSectionHead zrmcom.Hash) error {
	var root zrmcom.Hash
	if section > 0 {
