...
// to the ZRM network. The implementations of the functions should be non-blocking.
//
...
// validateTx checks whzerium a transaction is valid according to the consensus rules.
