...
// available in the database. It initialises the default Zerium header
// validator.
...
func (self *LightChain) loadLastState() error {
	if head := core.GetHeadHeaderHash(self.chainDb); head == (zrmcom.Hash{}) {
...
func (self *LightChain) LastBlockHash() zrmcom.Hash {
	self.mu.RLock()
	defer self.mu.RUnlock()
...
func (self *LightChain) Status() (td *big.Int, currentBlock zrmcom.Hash, genesisBlock zrmcom.Hash) {
	self.mu.RLock()
	defer self.mu.RUnlock()
...
func (self *LightChain) GetBody(ctx context.Context, hash zrmcom.Hash) (*types.Body, error) {
...
func (self *LightChain) GetBodyRLP(ctx context.Context, hash zrmcom.Hash) (rlp.RawValue, error) {
	// Short circuit if the body's already in the cache, retrieve otherwise
...
// it if present.
func (bc *LightChain) HasBlock(hash zrmcom.Hash, number uint64) bool {
...
// caching it if found.
func (self *LightChain) GetBlock(ctx context.Context, hash zrmcom.Hash, number uint64) (*types.Block, error) {
...
// caching it if found.
func (self *LightChain) GetBlockByHash(ctx context.Context, hash zrmcom.Hash) (*types.Block, error) {
...
func (self *LightChain) Rollback(chain []zrmcom.Hash) {
	self.mu.Lock()
...
func (self *LightChain) GetTd(hash zrmcom.Hash, number uint64) *big.Int {
	return self.hc.GetTd(hash, number)
}

// GetTdByHash retrieves a block's total difficulty in the canonical chain from the
// database by hash, caching it if found.
func (self *LightChain) GetTdByHash(hash zrmcom.Hash) *big.Int {
	return self.hc.GetTdByHash(hash)
}

// GetHeader retrieves a block header from the database by hash and number,
// caching it if found.
func (self *LightChain) GetHeader(hash zrmcom.Hash, number uint64) *types.Header {
	return self.hc.GetHeader(hash, number)
}

// GetHeaderByHash retrieves a block header from the database by hash, caching it if
// found.
func (self *LightChain) GetHeaderByHash(hash zrmcom.Hash) *types.Header {
	return self.hc.GetHeaderByHash(hash)
}

// HasHeader checks if a block header is present in the database or not, caching
// it if present.
func (bc *LightChain) HasHeader(hash zrmcom.Hash, number uint64) bool {
	return bc.hc.HasHeader(hash, number)
}

// GetBlockHashesFromHash retrieves a number of block hashes starting at a given
// hash, fetching towards the genesis block.
func (self *LightChain) GetBlockHashesFromHash(hash zrmcom.Hash, max uint64) []zrmcom.Hash {
