...
func (db *odrDatabase) OpenTrie(root zrmcom.Hash) (state.Trie, error) {
	return &odrTrie{db: db, id: db.id}, nil
}

func (db *odrDatabase) OpenStorageTrie(addrHash, root zrmcom.Hash) (state.Trie, error) {
...
func (db *odrDatabase) ContractCode(addrHash, codeHash zrmcom.Hash) ([]byte, error) {
...
func (db *odrDatabase) ContractCodeSize(addrHash, codeHash zrmcom.Hash) (int, error) {
...
func (t *odrTrie) CommitTo(db trie.DatabaseWriter) (zrmcom.Hash, error) {
	if t.trie == nil {
...
func (t *odrTrie) Hash() zrmcom.Hash {
	if t.trie == nil {
		return t.id.Root
	}
	return t.trie.Hash()
