...
type ChainConfig struct {
	...
	DAOForkSupport bool     `json:"daoForkSupport,omitempty"` // Whzerium the nodes supports or opposes the DAO hard-fork
...
// IsHomestead returns whzerium num is either equal to the homestead block or greater.
func (c *ChainConfig) IsHomestead(num *big.Int) bool {
	return isForked(c.HomesteadBlock, num)
}

// IsDAO returns whzerium num is either equal to the DAO fork block or greater.
...
// CheckCompatible checks whzerium scheduled fork transitions have been imported
...
// isForked returns whzerium a fork scheduled at block s is active at the given head block.
