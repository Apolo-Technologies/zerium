...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllAbthashProtocolChanges, new: AllAbthashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllAbthashProtocolChanges, new: AllAbthashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllAbthashProtocolChanges,
