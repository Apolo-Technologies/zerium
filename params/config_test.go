...
func TestCheckCompatible(t *testing.T) {
	...
	tests := []test{
		{stored: AllZrmashProtocolChanges, new: AllZrmashProtocolChanges, head: 0, wantErr: nil},
		{stored: AllZrmashProtocolChanges, new: AllZrmashProtocolChanges, head: 100, wantErr: nil},
		{
		...
		{
			stored: AllZrmashProtocolChanges,
