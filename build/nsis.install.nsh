Name "zrmd ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
...
!define ABOUTURL "https://github.com/apolo-technologies/zerium#zerium-go"
...
Section "Geth" GETH_IDX
  ...
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\zrmd.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\zrmd.exe" "attach" "" ""
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "Geth incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\zrmd.exe" "" "" "Zerium" 30303 "" "" ""
  SimpleFC::AdvAddRule "Geth outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\zrmd.exe" "" "" "Zerium" "" 30303 "" ""
  SimpleFC::AdvAddRule "Geth UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\zrmd.exe" "" "" "Zerium" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/apolo-technologies/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ZERIUM_SOCKET" "R" "HKLM" "\\.\pipe\zrmd.ipc"
  ${EnvVarUpdate} $0 "ZERIUM_SOCKET" "A" "HKLM" "\\.\pipe\zrmd.ipc"
