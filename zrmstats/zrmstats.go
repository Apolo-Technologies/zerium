...
type Service struct {
	server *peertopeer.Server        // Peer-to-peer server to retrieve networking infos
	eth    *eth.Zerium      // Full Zerium service if monitoring a full node
...
func New(url string, ethServ *eth.Zerium, lesServ *les.LightZerium) (*Service, error) {
...
// by the stats service (nil as it doesn't use the devpeertopeer overlay network).
func (s *Service) Protocols() []peertopeer.Protocol { return nil }
...
func (s *Service) Start(server *peertopeer.Server) error {
	s.server = server
	go s.loop()
...
type blockStats struct {
	...
	Miner      zrmcom.Address `json:"miner"`
	GasUsed    *big.Int       `json:"gasUsed"`
	GasLimit   *big.Int       `json:"gasLimit"`
	Diff       string         `json:"difficulty"`
	TotalDiff  string         `json:"totalDifficulty"`
	Txs        []txStats      `json:"transactions"`
	TxHash     zrmcom.Hash    `json:"transactionsRoot"`
	Root       zrmcom.Hash    `json:"stateRoot"`
