...
of the BMT hash), the ZVM word size to optimize for on-chain BMT verification
...
type Node struct {
	...
	root         bool  // whzerium the node is root to a smaller BMT
	isLeft       bool  // whzerium it is left side of the parent double segment
