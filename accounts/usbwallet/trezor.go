...
type trezorDriver struct {
	...
	pinwait bool          // Flags whzerium the device is waiting for PIN entry
...
// Status implements accounts.Wallet, always whzerium the Trezor is opened, closed
// or whzerium the Zerium app was not started on it.
