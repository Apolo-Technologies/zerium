...
The crypto is documented at https://github.com/apolo-technologies/wiki/wiki/ABT17-Secret-Storage-Definition
...
func (ks keyStorePassphrase) GetKey(addr zrmcom.Address, filename, auth string) (*Key, error) {
...
func StoreKey(dir, auth string, scryptN, scryptP int) (zrmcom.Address, error) {
