...
// Status implements accounts.Wallet, returning whzerium the account held by the
...
func (w *keystoreWallet) SelfDerive(base accounts.DerivationPath, chain abt.ChainStateReader) {}
