...
var (
	...
	cachetestAccounts = []accounts.Account{
		{
			Address: zrmcom.HexToAddress("7ef5a6135f1fd6a02593eedc869c6d41d934aef8"),
		...
		{
			Address: zrmcom.HexToAddress("f466859ead1932d743d622cb74fc058882e8648a"),
			URL:     accounts.URL{Scheme: KeyStoreScheme, Path: filepath.Join(cachetestDir, "aaa")},
		},
		{
			Address: zrmcom.HexToAddress("289d485d9771714cce91d3393d764e1311907acc"),
...
func TestCacheAddDeleteOrder(t *testing.T) {
	...
	accs := []accounts.Account{
		{
			Address: zrmcom.HexToAddress("095e7baea6a6c7c4c2dfeb977efac326af552d87"),
			URL:     accounts.URL{Scheme: KeyStoreScheme, Path: "-309830980"},
		},
		{
			Address: zrmcom.HexToAddress("2cac1adea150210703ba75ed097ddfe24e14f213"),
			URL:     accounts.URL{Scheme: KeyStoreScheme, Path: "ggg"},
		},
		{
			Address: zrmcom.HexToAddress("8bda78331c916a08481428e4b07c96d3e916d165"),
			URL:     accounts.URL{Scheme: KeyStoreScheme, Path: "zzzzzz-the-very-last-one.keyXXX"},
		},
		{
			Address: zrmcom.HexToAddress("d49ff4eeb0b2686ed89c0fc0f2b6ea533ddbbd5e"),
	...
	if cache.hasAddress(zrmcom.HexToAddress("fd9bd350f08ee3c0c19b85a8e16114a11a60aa4e")) {
		t.Errorf("expected hasAccount(%x) to return false", zrmcom.HexToAddress("fd9bd350f08ee3c0c19b85a8e16114a11a60aa4e"))
	}
	...
	cache.delete(accounts.Account{Address: zrmcom.HexToAddress("fd9bd350f08ee3c0c19b85a8e16114a11a60aa4e"), URL: accounts.URL{Scheme: KeyStoreScheme, Path: "something"}})
