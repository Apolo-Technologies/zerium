...
func TestKeyStore(t *testing.T) {
	...
	if zrmcom.FileExist(a.URL.Path) {
...
func TestWalletNotifications(t *testing.T) {
	...
	var (
		live       = make(map[zrmcom.Address]accounts.Account)
...
func checkAccounts(t *testing.T, live map[zrmcom.Address]accounts.Account, wallets []accounts.Wallet) {
