...
func tmpKeyStoreIface(t *testing.T, encrypted bool) (dir string, ks keyStore) {
	d, err := ioutil.TempDir("", "zrmd-keystore-test")
	if err != nil {
		t.Fatal(err)
	}
	if encrypted {
...
func TestImportPreSaleKey(t *testing.T) {
	...
	if account.Address != zrmcom.HexToAddress("d4584b5f6229b7be90727b0fc8c6b91bb427821f") {
...
// Test and utils for the key store tests in the Zerium JSON tests;
...
func skipIfSubmoduleMissing(t *testing.T) {
	if !zrmcom.FileExist(testsSubmodule) {
...
func TestV1_2(t *testing.T) {
	...
	addr := zrmcom.HexToAddress("cb61d5a9c4896fb9658090b597ef0e7be6f7b67e")
...
func loadKeyStoreTestV3(file string, t *testing.T) map[string]KeyStoreTestV3 {
	...
	err := zrmcom.LoadJSON(file, &tests)
	if err != nil {
		t.Fatal(err)
	}
	return tests
