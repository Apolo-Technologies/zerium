...
var waitDeployedTests = map[string]struct {
	code        string
	gas         *big.Int
	wantAddress zrmcom.Address
	wantErr     error
}{
	"successful deploy": {
		code:        `6060604052600a8060106000396000f360606040526008565b00`,
		gas:         big.NewInt(3000000),
		wantAddress: zrmcom.HexToAddress("0x3a220f351252089d385b29beca14e27f204c296a"),
	},
	"empty code": {
		code:        ``,
...
func TestWaitDeployed(t *testing.T) {
	for name, test := range waitDeployedTests {
		...
		tx := types.NewContractCreation(0, big.NewInt(0), test.gas, big.NewInt(1), zrmcom.FromHex(test.code))
