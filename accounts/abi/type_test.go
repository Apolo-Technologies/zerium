...
func TestTypeRegexp(t *testing.T) {
	tests := []struct {
		...
		{"address[]", Type{T: SliceTy, Kind: reflect.Slice, Type: reflect.TypeOf([]zrmcom.Address{}), Elem: &Type{Kind: reflect.Array, Type: address_t, Size: 20, T: AddressTy, stringKind: "address"}, stringKind: "address[]"}},
		{"address[2]", Type{Kind: reflect.Array, T: ArrayTy, Size: 2, Type: reflect.TypeOf([2]zrmcom.Address{}), Elem: &Type{Kind: reflect.Array, Type: address_t, Size: 20, T: AddressTy, stringKind: "address"}, stringKind: "address[2]"}},
...
func TestTypeCheck(t *testing.T) {
	for i, test := range []struct {
		...
		{"address[]", []zrmcom.Address{{1}}, ""},
		{"address[1]", []zrmcom.Address{{1}}, ""},
		{"address[1]", [1]zrmcom.Address{{1}}, ""},
		{"address[2]", [1]zrmcom.Address{{1}}, "abi: cannot use [1]array as type [2]array as argument"},
		{"bytes32", [32]byte{}, ""},
		{"bytes31", [31]byte{}, ""},
		{"bytes30", [30]byte{}, ""},
		{"bytes29", [29]byte{}, ""},
		...
		{"bytes32", zrmcom.Hash{1}, ""},
		{"bytes31", zrmcom.Hash{1}, "abi: cannot use zrmcom.Hash as type [31]uint8 as argument"},
		{"bytes31", [32]byte{}, "abi: cannot use [32]uint8 as type [31]uint8 as argument"},
		{"bytes", []byte{0, 1}, ""},
		{"bytes", [2]byte{0, 1}, "abi: cannot use array as type slice as argument"},
		{"bytes", zrmcom.Hash{1}, "abi: cannot use array as type slice as argument"},
		{"string", "hello world", ""},
		{"string", string(""), ""},
		{"string", []byte{}, "abi: cannot use slice as type string as argument"},
		{"bytes32[]", [][32]byte{{}}, ""},
		{"function", [24]byte{}, ""},
		{"bytes20", zrmcom.Address{}, ""},
		{"address", [20]byte{}, ""},
