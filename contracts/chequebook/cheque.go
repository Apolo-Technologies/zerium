...
// issuing, receiving, verifying cheques in zerium; (auto)cashing cheques in zerium
// as well as (auto)depositing zerium to the chequebook contract.
package chequebook
...
// * depositing zerium to the chequebook
// * watching incoming zerium
