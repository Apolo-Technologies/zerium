...
// DeployENS deploys a new Zerium contract, binding an instance of ENS to it.
func DeployENS(auth *bind.TransactOpts, backend bind.ContractBackend, owner zrmcom.Address) (zrmcom.Address, *types.Transaction, *ENS, error) {
	parsed, err := abi.JSON(strings.NewReader(ENSABI))
	if err != nil {
		return zrmcom.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, zrmcom.FromHex(ENSBin), backend, owner)
	if err != nil {
		return zrmcom.Address{}, nil, nil, err
	}
...
// ENS is an auto generated Go binding around an Zerium contract.
type ENS struct {
	ENSCaller     // Read-only binding to the contract
	ENSTransactor // Write-only binding to the contract
}

// ENSCaller is an auto generated read-only Go binding around an Zerium contract.
type ENSCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ENSTransactor is an auto generated write-only Go binding around an Zerium contract.
type ENSTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ENSSession is an auto generated Go binding around an Zerium contract,
...
// ENSCallerSession is an auto generated read-only Go binding around an Zerium contract,
...
// ENSTransactorSession is an auto generated write-only Go binding around an Zerium contract,
...
// ENSRaw is an auto generated low-level Go binding around an Zerium contract.
type ENSRaw struct {
	Contract *ENS // Generic contract binding to access the raw methods on
}

// ENSCallerRaw is an auto generated low-level read-only Go binding around an Zerium contract.
type ENSCallerRaw struct {
	Contract *ENSCaller // Generic read-only contract binding to access the raw methods on
}

// ENSTransactorRaw is an auto generated low-level write-only Go binding around an Zerium contract.
...
func NewENS(address zrmcom.Address, backend bind.ContractBackend) (*ENS, error) {
...
func NewENSCaller(address zrmcom.Address, caller bind.ContractCaller) (*ENSCaller, error) {
...
func NewENSTransactor(address zrmcom.Address, transactor bind.ContractTransactor) (*ENSTransactor, error) {
...
func bindENS(address zrmcom.Address, caller bind.ContractCaller, transactor bind.ContractTransactor) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(ENSABI))
	if err != nil {
		return nil, err
	}
...
func (_ENS *ENSCaller) Owner(opts *bind.CallOpts, node [32]byte) (zrmcom.Address, error) {
	var (
		ret0 = new(zrmcom.Address)
	)
	out := ret0
...
//
// Solidity: function owner(node bytes32) constant returns(address)
func (_ENS *ENSSession) Owner(node [32]byte) (zrmcom.Address, error) {
...
//
// Solidity: function owner(node bytes32) constant returns(address)
func (_ENS *ENSCallerSession) Owner(node [32]byte) (zrmcom.Address, error) {
	return _ENS.Contract.Owner(&_ENS.CallOpts, node)
}
...
func (_ENS *ENSCaller) Resolver(opts *bind.CallOpts, node [32]byte) (zrmcom.Address, error) {
	var (
		ret0 = new(zrmcom.Address)
	)
	out := ret0
...
//
// Solidity: function resolver(node bytes32) constant returns(address)
func (_ENS *ENSSession) Resolver(node [32]byte) (zrmcom.Address, error) {
...
//
// Solidity: function resolver(node bytes32) constant returns(address)
func (_ENS *ENSCallerSession) Resolver(node [32]byte) (zrmcom.Address, error) {
	return _ENS.Contract.Resolver(&_ENS.CallOpts, node)
}
...
func (_ENS *ENSTransactor) SetOwner(opts *bind.TransactOpts, node [32]byte, owner zrmcom.Address) (*types.Transaction, error) {
...
//
// Solidity: function setOwner(node bytes32, owner address) returns()
func (_ENS *ENSSession) SetOwner(node [32]byte, owner zrmcom.Address) (*types.Transaction, error) {
...
//
// Solidity: function setOwner(node bytes32, owner address) returns()
func (_ENS *ENSTransactorSession) SetOwner(node [32]byte, owner zrmcom.Address) (*types.Transaction, error) {
	return _ENS.Contract.SetOwner(&_ENS.TransactOpts, node, owner)
}
...
func (_ENS *ENSTransactor) SetResolver(opts *bind.TransactOpts, node [32]byte, resolver zrmcom.Address) (*types.Transaction, error) {
...
//
// Solidity: function setResolver(node bytes32, resolver address) returns()
func (_ENS *ENSSession) SetResolver(node [32]byte, resolver zrmcom.Address) (*types.Transaction, error) {
...
//
// Solidity: function setResolver(node bytes32, resolver address) returns()
func (_ENS *ENSTransactorSession) SetResolver(node [32]byte, resolver zrmcom.Address) (*types.Transaction, error) {
	return _ENS.Contract.SetResolver(&_ENS.TransactOpts, node, resolver)
}
...
func (_ENS *ENSTransactor) SetSubnodeOwner(opts *bind.TransactOpts, node [32]byte, label [32]byte, owner zrmcom.Address) (*types.Transaction, error) {
...
//
// Solidity: function setSubnodeOwner(node bytes32, label bytes32, owner address) returns()
func (_ENS *ENSSession) SetSubnodeOwner(node [32]byte, label [32]byte, owner zrmcom.Address) (*types.Transaction, error) {
...
//
// Solidity: function setSubnodeOwner(node bytes32, label bytes32, owner address) returns()
func (_ENS *ENSTransactorSession) SetSubnodeOwner(node [32]byte, label [32]byte, owner zrmcom.Address) (*types.Transaction, error) {
	return _ENS.Contract.SetSubnodeOwner(&_ENS.TransactOpts, node, label, owner)
}
...
// DeployFIFSRegistrar deploys a new Zerium contract, binding an instance of FIFSRegistrar to it.
func DeployFIFSRegistrar(auth *bind.TransactOpts, backend bind.ContractBackend, ensAddr zrmcom.Address, node [32]byte) (zrmcom.Address, *types.Transaction, *FIFSRegistrar, error) {
	parsed, err := abi.JSON(strings.NewReader(FIFSRegistrarABI))
	if err != nil {
		return zrmcom.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, zrmcom.FromHex(FIFSRegistrarBin), backend, ensAddr, node)
	if err != nil {
		return zrmcom.Address{}, nil, nil, err
	}
...
// FIFSRegistrar is an auto generated Go binding around an Zerium contract.
...
// FIFSRegistrarCaller is an auto generated read-only Go binding around an Zerium contract.
type FIFSRegistrarCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarTransactor is an auto generated write-only Go binding around an Zerium contract.
type FIFSRegistrarTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// FIFSRegistrarSession is an auto generated Go binding around an Zerium contract,
// with pre-set call and transact options.
...
// FIFSRegistrarCallerSession is an auto generated read-only Go binding around an Zerium contract,
// with pre-set call options.
...
// FIFSRegistrarTransactorSession is an auto generated write-only Go binding around an Zerium contract,
// with pre-set transact options.
...
// FIFSRegistrarRaw is an auto generated low-level Go binding around an Zerium contract.
type FIFSRegistrarRaw struct {
	Contract *FIFSRegistrar // Generic contract binding to access the raw methods on
}

// FIFSRegistrarCallerRaw is an auto generated low-level read-only Go binding around an Zerium contract.
...
// FIFSRegistrarTransactorRaw is an auto generated low-level write-only Go binding around an Zerium contract.
...
func NewFIFSRegistrar(address zrmcom.Address, backend bind.ContractBackend) (*FIFSRegistrar, error) {
...
func NewFIFSRegistrarCaller(address zrmcom.Address, caller bind.ContractCaller) (*FIFSRegistrarCaller, error) {
...
func NewFIFSRegistrarTransactor(address zrmcom.Address, transactor bind.ContractTransactor) (*FIFSRegistrarTransactor, error) {
...
func bindFIFSRegistrar(address zrmcom.Address, caller bind.ContractCaller, transactor bind.ContractTransactor) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(FIFSRegistrarABI))
	if err != nil {
		return nil, err
	}
...
func (_FIFSRegistrar *FIFSRegistrarTransactor) Register(opts *bind.TransactOpts, subnode [32]byte, owner zrmcom.Address) (*types.Transaction, error) {
...
//
// Solidity: function register(subnode bytes32, owner address) returns()
func (_FIFSRegistrar *FIFSRegistrarSession) Register(subnode [32]byte, owner zrmcom.Address) (*types.Transaction, error) {
...
//
// Solidity: function register(subnode bytes32, owner address) returns()
func (_FIFSRegistrar *FIFSRegistrarTransactorSession) Register(subnode [32]byte, owner zrmcom.Address) (*types.Transaction, error) {
	return _FIFSRegistrar.Contract.Register(&_FIFSRegistrar.TransactOpts, subnode, owner)
}
...
// DeployPublicResolver deploys a new Zerium contract, binding an instance of PublicResolver to it.
func DeployPublicResolver(auth *bind.TransactOpts, backend bind.ContractBackend, ensAddr zrmcom.Address) (zrmcom.Address, *types.Transaction, *PublicResolver, error) {
	parsed, err := abi.JSON(strings.NewReader(PublicResolverABI))
	if err != nil {
		return zrmcom.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, zrmcom.FromHex(PublicResolverBin), backend, ensAddr)
	if err != nil {
		return zrmcom.Address{}, nil, nil, err
	}
...
// PublicResolver is an auto generated Go binding around an Zerium contract.
type PublicResolver struct {
	PublicResolverCaller     // Read-only binding to the contract
	PublicResolverTransactor // Write-only binding to the contract
}

// PublicResolverCaller is an auto generated read-only Go binding around an Zerium contract.
type PublicResolverCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverTransactor is an auto generated write-only Go binding around an Zerium contract.
type PublicResolverTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// PublicResolverSession is an auto generated Go binding around an Zerium contract,
// with pre-set call and transact options.
...
// PublicResolverCallerSession is an auto generated read-only Go binding around an Zerium contract,
// with pre-set call options.
...
// PublicResolverTransactorSession is an auto generated write-only Go binding around an Zerium contract,
// with pre-set transact options.
...
// PublicResolverRaw is an auto generated low-level Go binding around an Zerium contract.
type PublicResolverRaw struct {
	Contract *PublicResolver // Generic contract binding to access the raw methods on
}

// PublicResolverCallerRaw is an auto generated low-level read-only Go binding around an Zerium contract.
...
// PublicResolverTransactorRaw is an auto generated low-level write-only Go binding around an Zerium contract.
...
func NewPublicResolver(address zrmcom.Address, backend bind.ContractBackend) (*PublicResolver, error) {
...
func NewPublicResolverCaller(address zrmcom.Address, caller bind.ContractCaller) (*PublicResolverCaller, error) {
...
func NewPublicResolverTransactor(address zrmcom.Address, transactor bind.ContractTransactor) (*PublicResolverTransactor, error) {
...
func bindPublicResolver(address zrmcom.Address, caller bind.ContractCaller, transactor bind.ContractTransactor) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(PublicResolverABI))
	if err != nil {
		return nil, err
	}
...
func (_PublicResolver *PublicResolverCaller) Addr(opts *bind.CallOpts, node [32]byte) (zrmcom.Address, error) {
	var (
		ret0 = new(zrmcom.Address)
	)
	out := ret0
...
//
// Solidity: function addr(node bytes32) constant returns(ret address)
func (_PublicResolver *PublicResolverSession) Addr(node [32]byte) (zrmcom.Address, error) {
...
//
// Solidity: function addr(node bytes32) constant returns(ret address)
func (_PublicResolver *PublicResolverCallerSession) Addr(node [32]byte) (zrmcom.Address, error) {
	return _PublicResolver.Contract.Addr(&_PublicResolver.CallOpts, node)
}
...
func (_PublicResolver *PublicResolverTransactor) SetAddr(opts *bind.TransactOpts, node [32]byte, addr zrmcom.Address) (*types.Transaction, error) {
...
//
// Solidity: function setAddr(node bytes32, addr address) returns()
func (_PublicResolver *PublicResolverSession) SetAddr(node [32]byte, addr zrmcom.Address) (*types.Transaction, error) {
...
//
// Solidity: function setAddr(node bytes32, addr address) returns()
func (_PublicResolver *PublicResolverTransactorSession) SetAddr(node [32]byte, addr zrmcom.Address) (*types.Transaction, error) {
	return _PublicResolver.Contract.SetAddr(&_PublicResolver.TransactOpts, node, addr)
}
...
// DeployResolver deploys a new Zerium contract, binding an instance of Resolver to it.
func DeployResolver(auth *bind.TransactOpts, backend bind.ContractBackend) (zrmcom.Address, *types.Transaction, *Resolver, error) {
	parsed, err := abi.JSON(strings.NewReader(ResolverABI))
	if err != nil {
		return zrmcom.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, zrmcom.FromHex(ResolverBin), backend)
	if err != nil {
		return zrmcom.Address{}, nil, nil, err
	}
...
// Resolver is an auto generated Go binding around an Zerium contract.
type Resolver struct {
	ResolverCaller     // Read-only binding to the contract
	ResolverTransactor // Write-only binding to the contract
}

// ResolverCaller is an auto generated read-only Go binding around an Zerium contract.
type ResolverCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ResolverTransactor is an auto generated write-only Go binding around an Zerium contract.
type ResolverTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ResolverSession is an auto generated Go binding around an Zerium contract,
// with pre-set call and transact options.
...
// ResolverCallerSession is an auto generated read-only Go binding around an Zerium contract,
// with pre-set call options.
...
// ResolverTransactorSession is an auto generated write-only Go binding around an Zerium contract,
// with pre-set transact options.
...
// ResolverRaw is an auto generated low-level Go binding around an Zerium contract.
type ResolverRaw struct {
	Contract *Resolver // Generic contract binding to access the raw methods on
}

// ResolverCallerRaw is an auto generated low-level read-only Go binding around an Zerium contract.
type ResolverCallerRaw struct {
	Contract *ResolverCaller // Generic read-only contract binding to access the raw methods on
}

// ResolverTransactorRaw is an auto generated low-level write-only Go binding around an Zerium contract.
...
func NewResolver(address zrmcom.Address, backend bind.ContractBackend) (*Resolver, error) {
...
func NewResolverCaller(address zrmcom.Address, caller bind.ContractCaller) (*ResolverCaller, error) {
...
func NewResolverTransactor(address zrmcom.Address, transactor bind.ContractTransactor) (*ResolverTransactor, error) {
...
func bindResolver(address zrmcom.Address, caller bind.ContractCaller, transactor bind.ContractTransactor) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(ResolverABI))
	if err != nil {
		return nil, err
	}
...
//
// Solidity: function addr(node bytes32) constant returns(ret address)
func (_Resolver *ResolverCaller) Addr(opts *bind.CallOpts, node [32]byte) (zrmcom.Address, error) {
	var (
		ret0 = new(zrmcom.Address)
	)
	out := ret0
...
//
// Solidity: function addr(node bytes32) constant returns(ret address)
func (_Resolver *ResolverSession) Addr(node [32]byte) (zrmcom.Address, error) {
...
//
// Solidity: function addr(node bytes32) constant returns(ret address)
func (_Resolver *ResolverCallerSession) Addr(node [32]byte) (zrmcom.Address, error) {
	return _Resolver.Contract.Addr(&_Resolver.CallOpts, node)
}
