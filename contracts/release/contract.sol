...
// ReleaseOracle is an Zerium contract to store the current and previous
// versions of the zerium implementation. Its goal is to allow Gzrm to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new Gzrm releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular Gzrm release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an Zerium user, either
