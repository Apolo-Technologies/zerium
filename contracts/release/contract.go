...
// DeployReleaseOracle deploys a new Zerium contract, binding an instance of ReleaseOracle to it.
func DeployReleaseOracle(auth *bind.TransactOpts, backend bind.ContractBackend, signers []zrmcom.Address) (zrmcom.Address, *types.Transaction, *ReleaseOracle, error) {
	parsed, err := abi.JSON(strings.NewReader(ReleaseOracleABI))
	if err != nil {
		return zrmcom.Address{}, nil, nil, err
	}
	address, tx, contract, err := bind.DeployContract(auth, parsed, zrmcom.FromHex(ReleaseOracleBin), backend, signers)
	if err != nil {
		return zrmcom.Address{}, nil, nil, err
	}
...
// ReleaseOracle is an auto generated Go binding around an Zerium contract.
...
// ReleaseOracleCaller is an auto generated read-only Go binding around an Zerium contract.
type ReleaseOracleCaller struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ReleaseOracleTransactor is an auto generated write-only Go binding around an Zerium contract.
type ReleaseOracleTransactor struct {
	contract *bind.BoundContract // Generic contract wrapper for the low level calls
}

// ReleaseOracleSession is an auto generated Go binding around an Zerium contract,
...
// ReleaseOracleCallerSession is an auto generated read-only Go binding around an Zerium contract,
...
// ReleaseOracleTransactorSession is an auto generated write-only Go binding around an Zerium contract,
...
// ReleaseOracleRaw is an auto generated low-level Go binding around an Zerium contract.
type ReleaseOracleRaw struct {
	Contract *ReleaseOracle // Generic contract binding to access the raw methods on
}

// ReleaseOracleCallerRaw is an auto generated low-level read-only Go binding around an Zerium contract.
...
// ReleaseOracleTransactorRaw is an auto generated low-level write-only Go binding around an Zerium contract.
...
func NewReleaseOracle(address zrmcom.Address, backend bind.ContractBackend) (*ReleaseOracle, error) {
...
func NewReleaseOracleCaller(address zrmcom.Address, caller bind.ContractCaller) (*ReleaseOracleCaller, error) {
...
func NewReleaseOracleTransactor(address zrmcom.Address, transactor bind.ContractTransactor) (*ReleaseOracleTransactor, error) {
...
func bindReleaseOracle(address zrmcom.Address, caller bind.ContractCaller, transactor bind.ContractTransactor) (*bind.BoundContract, error) {
	parsed, err := abi.JSON(strings.NewReader(ReleaseOracleABI))
	if err != nil {
		return nil, err
	}
...
func (_ReleaseOracle *ReleaseOracleCaller) AuthProposals(opts *bind.CallOpts) ([]zrmcom.Address, error) {
	var (
...
//
// Solidity: function authProposals() constant returns(address[])
func (_ReleaseOracle *ReleaseOracleSession) AuthProposals() ([]zrmcom.Address, error) {
...
//
// Solidity: function authProposals() constant returns(address[])
func (_ReleaseOracle *ReleaseOracleCallerSession) AuthProposals() ([]zrmcom.Address, error) {
	return _ReleaseOracle.Contract.AuthProposals(&_ReleaseOracle.CallOpts)
}
...
func (_ReleaseOracle *ReleaseOracleCaller) AuthVotes(opts *bind.CallOpts, user zrmcom.Address) (struct {
	Promote []zrmcom.Address
	Demote  []zrmcom.Address
}, error) {
	ret := new(struct {
		Promote []zrmcom.Address
		Demote  []zrmcom.Address
...
//
// Solidity: function authVotes(user address) constant returns(promote address[], demote address[])
func (_ReleaseOracle *ReleaseOracleSession) AuthVotes(user zrmcom.Address) (struct {
	Promote []zrmcom.Address
	Demote  []zrmcom.Address
}, error) {
...
//
// Solidity: function authVotes(user address) constant returns(promote address[], demote address[])
func (_ReleaseOracle *ReleaseOracleCallerSession) AuthVotes(user zrmcom.Address) (struct {
	Promote []zrmcom.Address
	Demote  []zrmcom.Address
}, error) {
	return _ReleaseOracle.Contract.AuthVotes(&_ReleaseOracle.CallOpts, user)
...
func (_ReleaseOracle *ReleaseOracleCaller) Signers(opts *bind.CallOpts) ([]zrmcom.Address, error) {
	var (
		ret0 = new([]zrmcom.Address)
	)
	out := ret0
...
//
// Solidity: function signers() constant returns(address[])
func (_ReleaseOracle *ReleaseOracleSession) Signers() ([]zrmcom.Address, error) {
...
//
// Solidity: function signers() constant returns(address[])
func (_ReleaseOracle *ReleaseOracleCallerSession) Signers() ([]zrmcom.Address, error) {
	return _ReleaseOracle.Contract.Signers(&_ReleaseOracle.CallOpts)
}
...
func (_ReleaseOracle *ReleaseOracleTransactor) Demote(opts *bind.TransactOpts, user zrmcom.Address) (*types.Transaction, error) {
...
//
// Solidity: function demote(user address) returns()
func (_ReleaseOracle *ReleaseOracleSession) Demote(user zrmcom.Address) (*types.Transaction, error) {
...
//
// Solidity: function demote(user address) returns()
func (_ReleaseOracle *ReleaseOracleTransactorSession) Demote(user zrmcom.Address) (*types.Transaction, error) {
	return _ReleaseOracle.Contract.Demote(&_ReleaseOracle.TransactOpts, user)
}
...
func (_ReleaseOracle *ReleaseOracleTransactor) Promote(opts *bind.TransactOpts, user zrmcom.Address) (*types.Transaction, error) {
...
//
// Solidity: function promote(user address) returns()
func (_ReleaseOracle *ReleaseOracleSession) Promote(user zrmcom.Address) (*types.Transaction, error) {
...
//
// Solidity: function promote(user address) returns()
func (_ReleaseOracle *ReleaseOracleTransactorSession) Promote(user zrmcom.Address) (*types.Transaction, error) {
	return _ReleaseOracle.Contract.Promote(&_ReleaseOracle.TransactOpts, user)
}
