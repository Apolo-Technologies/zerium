...
type Config struct {
	Oracle zrmcom.Address // Zerium address of the release oracle
...
func (r *ReleaseService) Protocols() []peertopeer.Protocol { return nil }
...
func (r *ReleaseService) Start(server *peertopeer.Server) error {
	go r.checker()
	return nil
}
