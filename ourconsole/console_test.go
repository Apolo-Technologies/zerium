...
func newTester(t *testing.T, confOverride func(*eth.Config)) *tester {
	...
	ethConf := &eth.Config{
		Genesis:   core.DeveloperGenesisBlock(15, zrmcom.Address{}),
		Etherbase: zrmcom.HexToAddress(testAddress),
...
func TestPrettyPrint(t *testing.T) {
	...
	var (
		one   = javascript_runtime_enviroment.NumberColor("1")
		two   = javascript_runtime_enviroment.StringColor("\"two\"")
		three = javascript_runtime_enviroment.NumberColor("3")
		null  = javascript_runtime_enviroment.SpecialColor("null")
		fun   = javascript_runtime_enviroment.FunctionColor("function()")
	)
...
func TestPrettyError(t *testing.T) {
	...
	want := javascript_runtime_enviroment.ErrorColor("hello") + "\n"
	if output := tester.output.String(); output != want {
