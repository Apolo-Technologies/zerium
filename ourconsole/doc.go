...
Because recording a human-meaningful message is zrmcom and good practice, the first argument to every
...
This package implements a number of Handlers for zrmcom logging patterns that are
