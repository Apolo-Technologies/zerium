...
// Note, this function is compatible with zrm_sign and personal_sign. As such it recovers
// the address of:
...
func (s *PrivateAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	...
	if sig[64] != 27 && sig[64] != 28 {
		return common.Address{}, fmt.Errorf("invalid Zerium signature (V is not 27 or 28)")
	}
...
//
// https://github.com/apolo-technologies/wiki/wiki/JSON-RPC#zrm_sign
...
func (api *PublicDebugAPI) SeedHash(ctx context.Context, number uint64) (string, error) {
	...
	return fmt.Sprintf("0x%x", abthash.SeedHash(number)), nil
}
