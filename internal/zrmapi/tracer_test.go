...
func (account) SetAddress(zrmcom.Address)                           {}
func (account) Value() *big.Int                                     { return nil }
func (account) SetBalance(*big.Int)                                 {}
func (account) SetNonce(uint64)                                     {}
func (account) Balance() *big.Int                                   { return nil }
func (account) Address() zrmcom.Address                             { return zrmcom.Address{} }
func (account) ReturnGas(*big.Int)                                  {}
func (account) SetCode(zrmcom.Hash, []byte)                         {}
func (account) ForEachStorage(cb func(key, value zrmcom.Hash) bool) {}

func runTrace(tracer *JavascriptTracer) (interface{}, error) {
	env := vm.NewZvm(vm.Context{}, nil, params.TestChainConfig, vm.Config{Debug: true, Tracer: tracer})
