...
// Vmodule sets the log verbosity pattern. See package zrm_log for details on the
// pattern syntax.
func (*HandlerT) Vmodule(pattern string) error {
	return glogger.Vmodule(pattern)
}

// BacktraceAt sets the log backtrace location. See package zrm_log for details on
// the pattern syntax.
