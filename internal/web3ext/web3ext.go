...
// package web3ext contains gzrm specific web3.js extensions.
package web3ext
...
web3._extend({
	...
	methods: [
		...
		new web3._extend.Method({
			...
			call: function(args) {
				return (web3._extend.utils.isString(args[0]) && args[0].indexOf('0x') === 0) ? 'zrm_getRawTransactionByBlockHashAndIndex' : 'zrm_getRawTransactionByBlockNumberAndIndex';
			},
			params: 2,
