...
func (javascript_runtime_enviroment *JAVASCRIPT_RUNTIME_ENVIROMENT) CompleteKeywords(line string) []string {
	var results []string
	javascript_runtime_enviroment.Do(func(vm *otto.Otto) {
