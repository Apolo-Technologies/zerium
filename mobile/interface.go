...
func (i *Interface) SetBinary(binary []byte)       { b := zrmcom.CopyBytes(binary); i.object = &b }
...
func (i *Interface) SetDefaultAddress()   { i.object = new(zrmcom.Address) }
func (i *Interface) SetDefaultAddresses() { i.object = new([]zrmcom.Address) }
func (i *Interface) SetDefaultHash()      { i.object = new(zrmcom.Hash) }
func (i *Interface) SetDefaultHashes()    { i.object = new([]zrmcom.Hash) }
...
func (i *Interface) GetAddress() *Address     { return &Address{*i.object.(*zrmcom.Address)} }
func (i *Interface) GetAddresses() *Addresses { return &Addresses{*i.object.(*[]zrmcom.Address)} }
func (i *Interface) GetHash() *Hash           { return &Hash{*i.object.(*zrmcom.Hash)} }
func (i *Interface) GetHashes() *Hashes       { return &Hashes{*i.object.(*[]zrmcom.Hash)} }
