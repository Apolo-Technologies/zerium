...
// determines the required input length. This function is zrmcomly used to implement the
...
// length of out determines the required input length. This function is zrmcomly used to
