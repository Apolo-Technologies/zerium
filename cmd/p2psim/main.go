// peertopeersim provides a command-line client for a simulation HTTP API.
//
// Here is an example of creating a 2 node network with the first node
// connected to the second:
//
//     $ peertopeersim node create
//     Created node01
//
//     $ peertopeersim node start node01
//     Started node01
//
//     $ peertopeersim node create
//     Created node02
//
//     $ peertopeersim node start node02
//     Started node02
//
//     $ peertopeersim node connect node01 node02
...
func main() {
	app := cli.NewApp()
	app.Usage = "devpeertopeer simulation command-line client"
	app.Flags = []cli.Flag{
		cli.StringFlag{
			Name:   "api",
...
func protocolList(node *peertopeer.NodeInfo) []string {
