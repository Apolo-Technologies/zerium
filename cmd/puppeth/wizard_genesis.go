...
func (w *wizard) makeGenesis() {
	...
	fmt.Println(" 1. Abthash - proof-of-work")
	fmt.Println(" 2. Clique - proof-of-authority")

	choice := w.read()
	switch {
	case choice == "1":
		// In case of abthash, we're pretty much done
		genesis.Config.Abthash = new(params.AbthashConfig)
	...
	genesis.Config.EnvId = new(big.Int).SetUint64(uint64(w.readDefaultInt(rand.Intn(65536))))
