...
var daoGenesisHash = zrmcom.HexToHash("5e1fc79cb4ffa4739177b5408045cd5d51c6cf766133f23f7cd72ee1f8d790e0")
...
func testDAOForkBlockNewChain(t *testing.T, test int, genesis string, expectBlock *big.Int, expectVote bool) {
	...
	if genesis != "" {
		...
		zrmd := runGeth(t, append(args, []string{"--exec", "2+2", "console"}...)...)
		zrmd.WaitExit()
	}
	// Retrieve the DAO config flag from the database
	path := filepath.Join(datadir, "zrmd", "chaindata")
	...
	genesisHash := zrmcom.HexToHash("0xd4e56740f876aef8c010b86a40d5f56745a118d0906a34e69aec8c0db1cb8fa3")
	if genesis != "" {
