...
var (
	walletCommand = cli.Command{
		...
		Description: `
    zrmd wallet import /path/to/my/presale.wallet
		...
		Subcommands: []cli.Command{
			{
				...
				Description: `
	zrmd wallet [options] /path/to/my/presale.wallet
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    zrmd account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    zrmd account import [options] <keyfile>
...
func accountCreate(ctx *cli.Context) error {
	cfg := zrmdConfig{Node: defaultNodeConfig()}
	// Load config file.
