...
// gzrm is the official command-line client for Zerium.
package main
...
const (
	clientIdentifier = "gzrm" // Client identifier to advertise over the network
)
...
// gzrm is the main entry point into the system if no special subcommand is ran.
// It creates a default node based on the command line arguments and runs it in
// blocking mode, waiting for it to be shut down.
func gzrm(ctx *cli.Context) error {
