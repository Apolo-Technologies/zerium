...
// Tests that initializing Gzrm with a custom genesis block and chain definitions
// work properly.
func TestCustomGenesis(t *testing.T) {
	for i, tt := range customGenesisTests {
		...
		runGzrm(t, "--datadir", datadir, "init", json).WaitExit()
