...
var (
	...
	nodeFlags = []cli.Flag{
		...
		utils.AbthashCacheDirFlag,
		utils.AbthashCachesInMemoryFlag,
		utils.AbthashCachesOnDiskFlag,
		utils.AbthashDatasetDirFlag,
		utils.AbthashDatasetsInMemoryFlag,
		utils.AbthashDatasetsOnDiskFlag,
