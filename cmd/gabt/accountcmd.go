...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage Zerium presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    zaed wallet import /path/to/my/presale.wallet

will prompt for your password and imports your zerium presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import Zerium presale wallet",
				ArgsUsage: "<keyFile>",
				...
				Description: `
	zaed wallet [options] /path/to/my/presale.wallet
...
between zerium nodes by simply copying.
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    zaed account update [options] <address>
...
For non-interactive use the passphrase can be specified with the -password flag:
    ...
    zaed account import [options] <keyfile>

Note:
As you can directly copy your encrypted accounts to another zerium instance,
