...
// for Gzrm and returns half of the allowance to assign to the database.
...
// new format.
//
// e.g. gzrm account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// gzrm --keystore /tmp/mykeystore --lightkdf account new
//
