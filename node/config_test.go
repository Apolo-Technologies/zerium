...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "zrmd.ipc", false, filepath.Join(os.TempDir(), "zrmd.ipc")},
		{"data", "zrmd.ipc", false, "data/zrmd.ipc"},
		{"data", "./zrmd.ipc", false, "./zrmd.ipc"},
		{"data", "/zrmd.ipc", false, "/zrmd.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "zrmd.ipc", true, `\\.\pipe\zrmd.ipc`},
		{"data", "zrmd.ipc", true, `\\.\pipe\zrmd.ipc`},
		{"data", `\\.\pipe\zrmd.ipc`, true, `\\.\pipe\zrmd.ipc`},
	}
...
func TestNodeKeyPersistency(t *testing.T) {
	...
	config := &Config{Name: "unit-test", DataDir: dir, P2P: peertopeer.Config{PrivateKey: key}}
	config.NodeKey()
