...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gzrm.ipc", false, filepath.Join(os.TempDir(), "gzrm.ipc")},
		{"data", "gzrm.ipc", false, "data/gzrm.ipc"},
		{"data", "./gzrm.ipc", false, "./gzrm.ipc"},
		{"data", "/gzrm.ipc", false, "/gzrm.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gzrm.ipc", true, `\\.\pipe\gzrm.ipc`},
		{"data", "gzrm.ipc", true, `\\.\pipe\gzrm.ipc`},
		{"data", `\\.\pipe\gzrm.ipc`, true, `\\.\pipe\gzrm.ipc`},
	}
