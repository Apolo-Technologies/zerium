...
func (s *NoopService) Protocols() []peertopeer.Protocol { return nil }
func (s *NoopService) APIs() []rpc.API           { return nil }
func (s *NoopService) Start(*peertopeer.Server) error   { return nil }
...
func (s *InstrumentedService) Start(server *peertopeer.Server) error {
	if s.startHook != nil {
		s.startHook(server)
	}
	return s.start
