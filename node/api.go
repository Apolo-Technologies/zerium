...
func (api *PublicAdminAPI) Peers() ([]*peertopeer.PeerInfo, error) {
	server := api.node.Server()
	if server == nil {
		return nil, ErrNodeStopped
	}
...
// protocol granularity.
func (api *PublicAdminAPI) NodeInfo() (*peertopeer.NodeInfo, error) {
	server := api.node.Server()
	if server == nil {
		return nil, ErrNodeStopped
	}
...
// PublicABT17API offers helper utils
type PublicABT17API struct {
	stack *Node
}

// NewPublicABT17API creates a new ABT17Service instance
func NewPublicABT17API(stack *Node) *PublicABT17API {
	return &PublicABT17API{stack}
}

// ClientVersion returns the node name
func (s *PublicABT17API) ClientVersion() string {
	return s.stack.Server().Name
}

// Sha3 applies the zerium sha3 implementation on the input.
// It assumes the input is hex encoded.
func (s *PublicABT17API) Sha3(input hexutil.Bytes) hexutil.Bytes {
