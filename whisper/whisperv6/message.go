...
type ReceivedMessage struct {
	...
	SymKeyHash   zrmcom.Hash // The Keccak256Hash of the key, associated with the Topic
	EnvelopeHash zrmcom.Hash // Message envelope hash to act as a unique id
}
...
func (msg *ReceivedMessage) isSymmetricEncryption() bool {
	return msg.SymKeyHash != zrmcom.Hash{}
}
