...
const (
	...
	peertopeerCode              = 2 // peer-to-peer message (to be consumed by the peer, but not forwarded any further)
	peertopeerRequestCode       = 3 // peer-to-peer message, used by Dapp protocol
