...
// Tests whzerium a message can be signed, and wrapped in plain-text.
...
// Tests whzerium a message can be encrypted and decrypted using an anonymous
...
// Tests whzerium a message can be properly signed and encrypted.
